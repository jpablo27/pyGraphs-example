...
with open('tRRT2.txt','r') as csvfile:
...
plt.scatter(0.02,9.8,s=600,c='r',alpha=1.0)

plt.scatter(-1.95,10.2,s=600,c='r',alpha=1.0)

for i, txt in enumerate(labs):
	ax.annotate(txt, (x_wps[i]+0.25,y_wps[i]+0.25), fontsize=22)

ax.annotate(u"$obstáculo1$",(0.02,8.3),fontsize=22)
ax.annotate(u"$obstáculo2$",(-2.5,11.7),fontsize=22)
